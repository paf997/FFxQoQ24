...
public class DraggableUI : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler,IPointerClickHandler
{
    ...
    {
        String cardDescriptionAsLog = GetComponent<PlayerCardUI>().cardData.description;
        Debug.Log("Clicked: " + cardDescriptionAsLog);
    }
